...
class RecipeDetailsPage:
    ...
    def initialize(self):
        ...
        # Recipe Name
        name_label = tk.Label(
            self._frame, text="Recipe Name:", bg="#1E1E1E", fg="white")
        name_label.grid(row=0, column=0, sticky="w", padx=5, pady=5)
        name_value = tk.Label(
            self._frame, text=self._recipe.name, bg="#1E1E1E", fg="white")
        ...
        ingredients_text = tk.Text(
            self._frame, wrap="word", height=10, width=40)
        ...
        time_value = tk.Label(self._frame, text=str(
            self._recipe.cooking_time), bg="#1E1E1E", fg="white")
        time_value.grid(row=2, column=1, padx=5, pady=5)

        # Back Button
        back_button = tk.Button(
            self._frame, text="Back", command=self._go_back_callback, bg="#444444", fg="white")
