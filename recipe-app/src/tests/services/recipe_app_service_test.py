...
class TestRecipeAppService(unittest.TestCase):
    def setUp(self):
        ...
        self.user = recipe_app_service.register_user(self.test_username,self.test_password)
    ...
    def test_login_succesful(self):
        ...
        self.assertEqual(user.username, user_repository.retrieve_all()[0].username)
